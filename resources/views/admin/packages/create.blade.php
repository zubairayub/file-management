                ...
                <div class="card-body">
                    <form action="{{ route('packages.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="quota" id="quota" class="form-control" value="{{ old('quota') }}" placeholder="Enter quota in KB (default)" required data-bs-toggle="tooltip" data-bs-placement="top" title="Enter the quota in KB. If you want to enter in MB or GB, the system will convert it to KB automatically (1 MB = 1024 KB, 1 GB = 1024 * 1024 KB).">
