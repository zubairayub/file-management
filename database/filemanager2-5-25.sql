...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 05, 2025 at 03:47 PM
...
(1, 'basic', 100, 0.00, '[\"Bookkeeping\",\"Taxes\",\"Payroll\",\"Business Formation\"]', '[\"Efficient LLC Registration\\r\",\"Seamless Compliance\\r\",\"(1 year free) then\\r\",\"$149\\/yr**\\r\",\"Operating agreement +$79\\r\",\"Employer ID Number\\r\",\"(EIN) +$79\\r\",\"Fast-track your filing +$49\\r\",\"Business documents +$89\"]', 'one-time', 'basic package for demo user', NULL, '2025-02-04 08:59:21'),
